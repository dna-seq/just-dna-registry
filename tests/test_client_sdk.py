...
_WRAPPED_ROUTES: dict[tuple[str, str], tuple[str, ...]] = {
    ...
    ("GET", "/api/v1/hint/variant"): ("hint_variant",),
    ("POST", "/api/v1/hint/variants"): ("hint_variants",),
    ("GET", "/api/v1/hint/citation"): ("hint_citation",),
    ("GET", "/api/v1/hint/gene"): ("hint_gene",),
    ("GET", "/api/v1/hint/trait"): ("hint_trait",),
    ("GET", "/api/v1/hint/old-assembly"): ("hint_old_assembly",),
